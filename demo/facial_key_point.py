...
# Main heading with customized markdown
st.markdown(
...
# Footer with markdown for better styling
# st.markdown(
#     """
#     <hr>
#     <p style='text-align: center; color: gray;'>Developed by Your Name | Powered by Streamlit</p>
#     """, 
#     unsafe_allow_html=True
# )
